...
public class SubscriberApi {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response addSubscriber(@Parameter(description = "", required = true) @FormParam("subscriberId") String subscriberId,
            @Parameter(description = "", required = true) @FormParam("organizationId") String organizationId, @Context SecurityContext securityContext)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response updateSubscriberById(@Parameter(description = "", required = true) @FormParam("subscriberId") String subscriberId2,
            @Parameter(description = "", required = true) @FormParam("organizationId") String organizationId, @PathParam("subscriberId") String subscriberId,
            @Context SecurityContext securityContext) throws NotFoundException {
