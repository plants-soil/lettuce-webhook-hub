...
public class PublisherApi {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response addDataGroup(@Parameter(description = "", required = true) @FormParam("dataGroupId") String dataGroupId,
            @Parameter(description = "", required = true) @FormParam("publisherId") String publisherId2,
            @Parameter(description = "", required = true) @FormParam("dataGroup") String dataGroup, @PathParam("publisherId") String publisherId,
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response addEvent(@Parameter(description = "", required = true) @FormParam("eventId") String eventId,
            @Parameter(description = "", required = true) @FormParam("publisherId") String publisherId2,
            ...
            @Parameter(description = "", required = true, schema = @Schema(allowableValues = { "SUBMITTED", "PUBLISHED",
                    "RETIRED" })) @FormParam("eventStatus") String eventStatus,
            @PathParam("publisherId") String publisherId, @Context SecurityContext securityContext) throws NotFoundException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response addPublisher(@Parameter(description = "", required = true) @FormParam("publisherId") String publisherId,
            @Parameter(description = "", required = true) @FormParam("organizationId") String organizationId,
            @Parameter(description = "", required = true) @FormParam("supportDataGroup") Boolean supportDataGroup,
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response updatePublisherById(@Parameter(description = "", required = true) @FormParam("publisherId") String publisherId2,
            @Parameter(description = "", required = true) @FormParam("organizationId") String organizationId,
            @Parameter(description = "", required = true) @FormParam("supportDataGroup") Boolean supportDataGroup,
            @Parameter(description = "", required = true) @FormParam("version") String version,
            @Parameter(description = "", required = true) @FormParam("createdBy") String createdBy,
            @Parameter(description = "", required = true) @FormParam("creationTime") Date creationTime, @PathParam("publisherId") String publisherId,
            @Context SecurityContext securityContext) throws NotFoundException {
