...
public interface PublisherApiService {
      ...
      Response addDataGroups(List<com.plantssoil.webhook.core.registry.InMemoryDataGroup> body,String publisherId,SecurityContext securityContext) throws NotFoundException;
      ...
      Response addEvent(String eventId,String publisherId2,String eventType,String eventTag,String contentType,String charset,String eventStatus,String publisherId,SecurityContext securityContext) throws NotFoundException;
      Response addEvents(List<com.plantssoil.webhook.core.registry.InMemoryEvent> body,String publisherId,SecurityContext securityContext) throws NotFoundException;
      ...
      Response addPublisher(String publisherId,String organizationId,Boolean supportDataGroup,String version,String createdBy,Date creationTime,SecurityContext securityContext) throws NotFoundException;
      ...
      Response updatePublisherById(com.plantssoil.webhook.core.registry.InMemoryPublisher body,String publisherId,SecurityContext securityContext) throws NotFoundException;
      Response updatePublisherById(String publisherId2,String organizationId,Boolean supportDataGroup,String version,String createdBy,Date creationTime,String publisherId,SecurityContext securityContext) throws NotFoundException;
}
