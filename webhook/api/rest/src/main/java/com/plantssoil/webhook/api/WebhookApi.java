...
public class WebhookApi {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response addWebhook(@Parameter(description = "", required = true) @FormParam("webhookId") String webhookId,
            @Parameter(description = "", required = true) @FormParam("subscriberId") String subscriberId,
            @Parameter(description = "", required = true) @FormParam("appName") String appName,
            @Parameter(description = "", required = true) @FormParam("appTag") String appTag,
            @Parameter(description = "", required = true) @FormParam("description") String description,
            @Parameter(description = "", required = true) @FormParam("webhookSecret") String webhookSecret,
            @Parameter(description = "", required = true) @FormParam("publisherId") String publisherId,
            @Parameter(description = "", required = true) @FormParam("publisherVersion") String publisherVersion,
            @Parameter(description = "", required = true, schema = @Schema(allowableValues = { "SIGNATURE", "TOKEN",
                    "NONE" })) @FormParam("securityStrategy") String securityStrategy,
            @Parameter(description = "", required = true) @FormParam("webhookUrl") String webhookUrl,
            @Parameter(description = "", required = true) @FormParam("customizedHeaders") String customizedHeaders,
            @Parameter(description = "", required = true) @FormParam("trustedIps") List<String> trustedIps,
            @Parameter(description = "", required = true, schema = @Schema(allowableValues = { "TEST", "AWAITING_FOR_APPROVEL", "PRODUCTION",
                    "INACTIVE" })) @FormParam("webhookStatus") String webhookStatus,
        ...
        return service.addWebhook(webhookId, subscriberId, appName, appTag, description, webhookSecret, publisherId, publisherVersion, securityStrategy,
                webhookUrl, customizedHeaders, trustedIps, webhookStatus, createdBy, creationTime, securityContext);
    }
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response subscribeDataGroup(@NotNull @QueryParam("webhookId") String webhookId, @NotNull @QueryParam("dataGroupId") String dataGroupId,
            @Context SecurityContext securityContext) throws NotFoundException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response subscribeDataGroups(@NotNull @QueryParam("webhookId") String webhookId, @NotNull @QueryParam("dataGroupIds") List<String> dataGroupIds,
            @Context SecurityContext securityContext) throws NotFoundException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response subscribeEvent(@NotNull @QueryParam("webhookId") String webhookId, @NotNull @QueryParam("eventId") String eventId,
            @Context SecurityContext securityContext) throws NotFoundException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response subscribeEvents(@NotNull @QueryParam("webhookId") String webhookId, @NotNull @QueryParam("eventIds") List<String> eventIds,
            @Context SecurityContext securityContext) throws NotFoundException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response unsubscribeDataGroup(@NotNull @QueryParam("webhookId") String webhookId, @NotNull @QueryParam("dataGroupId") String dataGroupId,
            @Context SecurityContext securityContext) throws NotFoundException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response unsubscribeDataGroups(@NotNull @QueryParam("webhookId") String webhookId, @NotNull @QueryParam("dataGroupIds") List<String> dataGroupIds,
            @Context SecurityContext securityContext) throws NotFoundException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response unsubscribeEvent(@NotNull @QueryParam("webhookId") String webhookId, @NotNull @QueryParam("eventId") String eventId,
            @Context SecurityContext securityContext) throws NotFoundException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response unsubscribeEvents(@NotNull @QueryParam("webhookId") String webhookId, @NotNull @QueryParam("eventIds") List<String> eventIds,
            @Context SecurityContext securityContext) throws NotFoundException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found the web service") })
    public Response updateWebhookById(@Parameter(description = "", required = true) @FormParam("webhookId") String webhookId2,
            @Parameter(description = "", required = true) @FormParam("subscriberId") String subscriberId,
            @Parameter(description = "", required = true) @FormParam("appName") String appName,
            @Parameter(description = "", required = true) @FormParam("appTag") String appTag,
            @Parameter(description = "", required = true) @FormParam("description") String description,
            ...
            @Parameter(description = "", required = true, schema = @Schema(allowableValues = { "TEST", "AWAITING_FOR_APPROVEL", "PRODUCTION",
                    "INACTIVE" })) @FormParam("webhookStatus") String webhookStatus,
            @Parameter(description = "", required = true) @FormParam("createdBy") String createdBy,
            @Parameter(description = "", required = true) @FormParam("creationTime") Date creationTime, @PathParam("webhookId") String webhookId,
            @Context SecurityContext securityContext) throws NotFoundException {
        return service.updateWebhookById(webhookId2, subscriberId, appName, appTag, description, webhookSecret, publisherId, publisherVersion, securityStrategy,
                webhookUrl, customizedHeaders, trustedIps, webhookStatus, createdBy, creationTime, webhookId, securityContext);
    }
}
