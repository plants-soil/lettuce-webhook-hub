 ...
 */
@Entity
@Table(name = "LETTUCE_PUBLISHER", uniqueConstraints = @UniqueConstraint(columnNames = "organizationId"), indexes = {
        @Index(name = "idx_publisher_orgid", columnList = "organizationId") })
