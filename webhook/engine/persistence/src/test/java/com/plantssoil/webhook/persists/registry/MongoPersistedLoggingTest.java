...
public class MongoPersistedLoggingTest extends PersistedRegistryTestParent {
    private static TempDirectoryUtility util = new TempDirectoryUtility();

    public static void main(String[] args) throws Exception {
        MongoPersistedLoggingTest test = new MongoPersistedLoggingTest();
        MongoPersistedLoggingTest.setUpBeforeClass();
        test.test01Logging();
        MongoPersistedLoggingTest.tearDownAfterClass();
    }
    ...
    public static void tearDownAfterClass() throws Exception {
        ...
        try (IPersistence p = f.create()) {
            ...
            deleteAllData(p, WebhookLog.class);
            deleteAllData(p, WebhookLogLine.class);
        }
