...
public interface IConfiguration {
     ...
     * Configuration that starts with the specified prefix. The prefix is removed
     * from the keys in the subset. For example, if the configuration contains the
     ...
     *
     * @return {@code true} if the configuration contains no property, {@code false}
     *         otherwise.
     */
    boolean isEmpty();
    ...
    /**
     * Set a property, this will replace any previously set values. Set values is
     * implicitly a call to clearProperty(key), addProperty(key, value).
     *
     ...
     * retrieving values of properties. In a typical implementation of the
     * {@code Configuration} interface the other get methods (that return specific
     * data types) will internally make use of this method. On this level variable
     * substitution is not yet performed. The returned object is an internal
     * representation of the property value for the passed in key. It is owned by
     * the {@code Configuration} object. So a caller should not modify this object.
     * It cannot be guaranteed that this object will stay constant over time (i.e.
     * further update operations on the configuration may change its internal
     * state).
     *
     * @param key property to retrieve
     * @return the value to which this configuration maps the specified key, or null
     *         if the configuration contains no mapping for this key.
     */
    Object getProperty(String key);

    /**
     * Get the list of the keys contained in the configuration that match the
     * specified prefix. For instance, if the configuration contains the following
     * keys:<br>
     ...
     * iterator can be used to obtain all defined keys. Note that the exact behavior
     * of the iterator's {@code remove()} method is specific to a concrete
     * implementation. It <em>may</em> remove the corresponding property from the
     * configuration, but this is not guaranteed. In any case it is no replacement
     * for calling {@link #clearProperty(String)} for this property. So it is highly
     * recommended to avoid using the iterator's {@code remove()} method.
     *
     * @return An Iterator.
     */
    ...
    /**
     * Get a list of properties associated with the given configuration key. This
     * method expects the given key to have an arbitrary number of String values,
     * each of which is of the form {code key=value}. These strings are split at the
     * equals sign, and the key parts will become keys of the returned
     * {@code Properties} object, the value parts become values.
     *
    ...
    /**
     * Get a boolean associated with the given configuration key. If the key doesn't
     ...
     * @param key          The configuration key.
     * @param defaultValue The default value.
     * @return The associated boolean if key is found and has valid format, default
     *         value otherwise.
     *
     * @throws ConversionException is thrown if the key maps to an object that is
     *                             not a Boolean.
    ...
    /**
     * Get a byte associated with the given configuration key. If the key doesn't
     * map to an existing object, the default value is returned.
     *
     * @param key          The configuration key.
     * @param defaultValue The default value.
    ...
    /**
     * Get a double associated with the given configuration key. If the key doesn't
     * map to an existing object, the default value is returned.
     *
     * @param key          The configuration key.
     * @param defaultValue The default value.
     ...
     * @param key          The configuration key.
     * @param defaultValue The default value.
     * @return The associated double if key is found and has valid format, default
     *         value otherwise.
     *
     * @throws ConversionException is thrown if the key maps to an object that is
     *                             not a Double.
    ...
    /**
     * Get a float associated with the given configuration key. If the key doesn't
     * map to an existing object, the default value is returned.
     *
     * @param key          The configuration key.
     * @param defaultValue The default value.
    ...
    /**
     * Get a {@link Float} associated with the given configuration key. If the key
     * doesn't map to an existing object, the default value is returned.
     *
     * @param key          The configuration key.
     * @param defaultValue The default value.
     * @return The associated float if key is found and has valid format, default
     *         value otherwise.
     *
     * @throws ConversionException is thrown if the key maps to an object that is
     *                             not a Float.
    ...
    /**
     * Get a int associated with the given configuration key. If the key doesn't map
    ...
    /**
     * Get an {@link Integer} associated with the given configuration key. If the
    ...
    /**
     * Get a long associated with the given configuration key. If the key doesn't
     * map to an existing object, the default value is returned.
     *
     * @param key          The configuration key.
     * @param defaultValue The default value.
    ...
    /**
     * Get a {@link Long} associated with the given configuration key. If the key
     * doesn't map to an existing object, the default value is returned.
     *
     * @param key          The configuration key.
     * @param defaultValue The default value.
    ...
    /**
     * Get a {@link Short} associated with the given configuration key. If the key
     * doesn't map to an existing object, the default value is returned.
     *
     * @param key          The configuration key.
     * @param defaultValue The default value.
     * @return The associated short if key is found and has valid format, default
     *         value otherwise.
     *
     * @throws ConversionException is thrown if the key maps to an object that is
     *                             not a Short.
    ...
    /**
     * Get a {@link BigDecimal} associated with the given configuration key. If the
     * key doesn't map to an existing object, the default value is returned.
     *
     * @param key          The configuration key.
     * @param defaultValue The default value.
    ...
    /**
     * Get a {@link BigInteger} associated with the given configuration key. If the
     * key doesn't map to an existing object, the default value is returned.
     *
     * @param key          The configuration key.
     * @param defaultValue The default value.
    ...
    /**
     * Get a string associated with the given configuration key. If the key doesn't
     * map to an existing object, the default value is returned.
     *
     * @param key          The configuration key.
     * @param defaultValue The default value.
     * @return The associated string if key is found and has valid format, default
     *         value otherwise.
     *
     * @throws ConversionException is thrown if the key maps to an object that is
     *                             not a String.
    ...
    /**
     * Get an array of strings associated with the given configuration key. If the
     * key doesn't map to an existing object an empty array is returned
     *
     * @param key The configuration key.
    ...
    /**
     * Get a List of strings associated with the given configuration key. If the key
     * doesn't map to an existing object an empty List is returned.
     *
     * @param key The configuration key.
